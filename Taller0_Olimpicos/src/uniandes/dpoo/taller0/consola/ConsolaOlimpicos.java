...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar función Taller N°1\n");
...
private void ejecutarFuncionLab()
	{
		System.out.println("\n" + "Función Taller N°1" + "\n");
		try
		{
			String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
			String resp= calculadora.ejecutarFuncionLab(nombre_atleta);
			if (resp == null)
			{
				System.out.println("No se encontró un atleta llamado " + nombre_atleta);
			}
			...
			{
				System.out.println("El país que representa " + nombre_atleta+ "es: "+resp);
			}
		}
		catch(NullPointerException e) {
			System.out.println("no se encontró un atleta con este nombre :(");
		}
	}
